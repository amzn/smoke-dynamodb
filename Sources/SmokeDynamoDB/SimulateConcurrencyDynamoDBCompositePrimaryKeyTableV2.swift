 ...
 */
#if compiler(>=5.7)
public class SimulateConcurrencyDynamoDBCompositePrimaryKeyTableV2: DynamoDBCompositePrimaryKeyTableV2 {
    let wrappedDynamoDBTable: DynamoDBCompositePrimaryKeyTableV2
     ...
     */
    public init(wrappedDynamoDBTable: DynamoDBCompositePrimaryKeyTableV2, simulateConcurrencyModifications: Int,
    ...
    where AttributesType : PrimaryKeyAttributes, ItemType : Decodable, ItemType : Encodable {
        try self.wrappedDynamoDBTable.validateEntry(entry: entry)
    }
}
#endif
