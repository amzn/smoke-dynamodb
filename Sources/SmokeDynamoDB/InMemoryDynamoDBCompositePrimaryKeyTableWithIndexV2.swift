...
public struct InMemoryDynamoDBCompositePrimaryKeyTableWithIndexV2<GSILogic: DynamoDBCompositePrimaryKeyGSILogicV2>: DynamoDBCompositePrimaryKeyTableV2 {
    ...
    public init(gsiName: String,
        ...
        self.primaryTable = InMemoryDynamoDBCompositePrimaryKeyTableV2(executeItemFilter: executeItemFilter)
        self.gsiDataStore = InMemoryDynamoDBCompositePrimaryKeyTableV2(executeItemFilter: executeItemFilter)
    }
    ...
    where AttributesType : PrimaryKeyAttributes, ItemType : Decodable, ItemType : Encodable {
        try self.primaryTable.validateEntry(entry: entry)
    }
}
#endif
